        ...
        <section className="section-padding relative">
            <div className="max-w-[1200px] mx-auto">
                            ...
                            >
                                ...
                                <div className="py-6 md:py-8 flex items-center justify-between gap-4">
                                    <div className="flex items-baseline gap-3 md:gap-5 min-w-0">
                                        <span className="text-xs font-mono text-slate-500 tracking-wider shrink-0">
                                    ...
                                    <div className="flex items-center gap-3 shrink-0">
                                        <span className="hidden md:block text-xs font-mono text-slate-500 uppercase tracking-wider">
                                            {project.category}
                                        </span>
                                                    ...
                                                    <div className="absolute bottom-4 left-4 right-4 flex items-end justify-between">
                                                        ...
                                                        <div className="flex gap-1.5 shrink-0 ml-4">
                                                            {project.techStack.slice(0, 3).map((tech) => (
                                                                <span key={tech} className="px-2 py-0.5 bg-white/20 backdrop-blur-md rounded text-[11px] text-white font-mono">
                                                                    {tech}
                                                                </span>
                                                            ))}
                                                        </div>
                ...
                >
                    <Link
                        href="/projects"
                        className="group inline-flex items-center gap-2.5 px-6 py-3 border border-slate-300 hover:border-slate-900 hover:bg-slate-900 hover:text-white text-slate-700 text-xs font-bold uppercase tracking-[0.12em] rounded-full transition-all duration-300"
                    >
                        All Projects
